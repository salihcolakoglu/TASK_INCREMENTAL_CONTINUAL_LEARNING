"""
Quick test runner for sigmoid fine-tuning.
Use this to verify the sigmoid implementation works correctly.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Test Sigmoid Fine-tuning')
    ...
    print(f"\n{'='*60}")
    print(f"SIGMOID FINE-TUNING TEST")
    print(f"{'='*60}")
